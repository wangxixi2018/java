...
function index1(){
	...
	$.post("../Goods.do",{"opr":"showindex1","g_sonID":3},function(data){
		pagedata=data;
...
function toolp(){
	$(".cate_list").empty();
	if(num==0){	
		$.post("../Goods.do",{"opr":"GoodsG_g_priceSonDown","g_sonID":3},function(data){
			pagedata=data;
			pages(indexs);
			show();
		},"json")
		...
		$.post("../Goods.do",{"opr":"GoodsG_g_priceSonUp","g_sonID":3},function(data){
			pagedata=data;
			pages(indexs);
			show();
		},"json")
