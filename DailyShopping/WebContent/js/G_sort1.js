...
function index1(){
	...
	$.post("../Goods.do",{"opr":"showGoods_gson2","g_sort2ID":1},function(data){
		pagedata=data;
...
function toolp(){
	$(".cate_list").empty();
	if(num==0){	
		$.post("../Goods.do",{"opr":"GoodsG_g_priceDown","g_sort2ID":1},function(data){
			pagedata=data;
			pages(indexs);
			show();
		},"json")
		...
		$.post("../Goods.do",{"opr":"GoodsG_g_priceUp","g_sort2ID":1},function(data){
			pagedata=data;
			pages(indexs);
			show();
		},"json")
